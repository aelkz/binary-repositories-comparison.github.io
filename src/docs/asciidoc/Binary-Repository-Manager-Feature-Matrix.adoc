...
|Applicability Reports (the ability to report on which clients need which software updates to be applied
|?
|?
|?
|&#10004;
...
|&#10004; +
Pulp has a very flexible permission system that makes it possible to restrict access to
all of its API paths and reposistories at a very fine grained level.
...
|&#10004; +
Pulp doesn't use XML, but it also does not store passwords in configuration files. Passwords are
